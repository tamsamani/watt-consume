...
export default class Main extends Component {
	...
	getPageTitle(active) {
		switch (active) {
			case "home_0": return "WhatsConsum?";
			case "add_1": return "Equipmnets";
			case "assignment_2": return "History";
			case "settings_3": return "Settings";
			case "get_app_4": return "Download & Backup";
			case "help_5": return "Help Page";
			default: return "WhatsConsum?";
		}
	}
